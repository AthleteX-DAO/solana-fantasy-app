...
// localnet program
export const programId = new PublicKey('9yfdNX1GJGpAM4cVF9DPWhDbpCFTnqTpLFqRVPtrjgvo');
export const rootPublicKey = new PublicKey('2qX95gJwuXfDK3inyV6D8tEyo71q9SCfe7gNs6kesmk9');
