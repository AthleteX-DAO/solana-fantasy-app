...
window.sfsProgramId = new PublicKey('6B5X76dzGzZuwJp2RHYXUivwKqi4QKrB3rY8yJcjoA1V');
window.sfsRoot = new PublicKey('67obULi8S7rDUwPyFLpjgsn6kn7qsoTk9vdKc4zMB9Bg');
