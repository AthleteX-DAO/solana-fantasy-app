...
window.sfsProgramId = new PublicKey('72BADLV6Q13BCcVjWswedX6uBYykZGvqWbCDpVfcGqVN');
window.sfsRoot = new PublicKey('64SthGW3gwc8TX1xuoemhs9BZSFb5eTY5CoZTZ3Kmo9o');
