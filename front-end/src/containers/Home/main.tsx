    ...
    <div className="row">
      ...
      <div className="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
        ...
        <div style={{ textAlign: 'left' }}>
          ...
          <br />
          <u>Step 8:</u> As each week is completed, use the oracle to pass in the scores When a week
          is completed you need to run the Increment Week script and Update scores script. For this
          you will need to locally setup the project on your machine. Have a look at pre-requisites.
          <br />
          <u>Step 9:</u> Use the scoreboard to tabulate scores, and withdraw winnings once the
          season is over.
          <br />
        </div>
      </div>
