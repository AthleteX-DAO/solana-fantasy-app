        ...
        <Card.Body>
          ...
          <Dropdown className="my-4">
            ...
            <Dropdown.Menu>
              <Dropdown.Item
                onClick={() => {
                  setLeagueType('NFL Classic');
                  setPositionOptions(nflDefault);
                }}
              >
                NFL Classic
              </Dropdown.Item>
              <Dropdown.Item
                onClick={() => {
                  setLeagueType('NBA Classic');
                  setPositionOptions(nbaDefault);
                }}
              >
                NBA Classic
              </Dropdown.Item>
          ...
          {advancedMenu ? (
            <div>
              <span
                style={{ display: 'block', textDecorationLine: 'underline' }}
                onClick={() => setAdvancedMenu(false)}
              >
                Hide
              </span>
              <span style={{ display: 'block' }}>
                Enter the number of each position that will be started in a lineup
              </span>
              <span style={{ display: 'block' }}>
                If a position is set to 0, players in that position will not be able to be drafted
              </span>
              QB:
              <Form.Control
                style={{
                ...
                onChange={(e) =>
                  setPositionOptions([
                    ...positionOptions.slice(0, 2),
                    parseInt(e.target.value, 10) || 0,
                    ...positionOptions.slice(3),
                  ])
                }
              ...
              <Form.Control
                ...
                onChange={(e) =>
                  setPositionOptions([
                    ...positionOptions.slice(0, 3),
                    parseInt(e.target.value, 10) || 0,
                    ...positionOptions.slice(4),
                  ])
                }
              ...
              <Form.Control
                ...
                onChange={(e) =>
                  setPositionOptions([
                    ...positionOptions.slice(0, 4),
                    parseInt(e.target.value, 10) || 0,
                    ...positionOptions.slice(5),
                  ])
                }
              ...
              <Form.Control
                ...
                onChange={(e) =>
                  setPositionOptions([
                    ...positionOptions.slice(0, 5),
                    parseInt(e.target.value, 10) || 0,
                    ...positionOptions.slice(6),
                  ])
                }
              ...
              <Form.Control
                ...
                onChange={(e) =>
                  setPositionOptions([
                    ...positionOptions.slice(0, 6),
                    parseInt(e.target.value, 10) || 0,
                    ...positionOptions.slice(7),
                  ])
                }
              ...
              <Form.Control
                ...
                onChange={(e) =>
                  setPositionOptions([
                    ...positionOptions.slice(0, 7),
                    parseInt(e.target.value, 10) || 0,
                    ...positionOptions.slice(8),
                  ])
                }
              ...
              <Form.Control
                ...
                onChange={(e) =>
                  setPositionOptions([
                    ...positionOptions.slice(0, 8),
                    parseInt(e.target.value, 10) || 0,
                    ...positionOptions.slice(9),
                  ])
                }
              ...
              <Form.Control
                ...
                onChange={(e) =>
                  setPositionOptions([
                    ...positionOptions.slice(0, 9),
                    parseInt(e.target.value, 10) || 0,
                    ...positionOptions.slice(10),
                  ])
                }
